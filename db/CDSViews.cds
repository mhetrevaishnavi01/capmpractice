...
context CDSViews {
    ...
    define view![ProductValueHelp] as //for helping user for ui screens
...
//in short this is order id
    define view![ItemView] as //creating view with only one database table, this will be used in other view (below)
...
//we can do mixin with cds views only that why itemview we created
